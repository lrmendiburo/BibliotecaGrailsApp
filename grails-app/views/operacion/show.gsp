...
<html>
    ...
    <body>
        ...
        <div id="show-operacion" class="content scaffold-show" role="main">
            ...
            <f:display bean="operacion" />
            <g:form resource="${this.operacion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.operacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
